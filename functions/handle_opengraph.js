...
const currentDir = process.env.LAMBDA_TASK_ROOT ? process.env.LAMBDA_TASK_ROOT : __dirname;
...
async function processIgStoryImageToBuffer(ogData, ogImage) {
  ...
  let titleFont = await Jimp.loadFont(currentDir + '/GothicA1-SemiBold-85/GothicA1-SemiBold.ttf.fnt');
  let urlFont = await Jimp.loadFont(currentDir + '/GothicA1-Regular-50/GothicA1-Regular.ttf.fnt');
...
async function processIgFeedImageToBuffer(ogData, ogImage) {
  ...
  // generated with https://ttf2fnt.com/
  let titleFont = await Jimp.loadFont(currentDir + '/GothicA1-SemiBold-50/GothicA1-SemiBold.ttf.fnt');
  let urlFont = await Jimp.loadFont(currentDir + '/GothicA1-Regular-32/GothicA1-Regular.ttf.fnt');
